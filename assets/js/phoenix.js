      ...
      e &&
        e.querySelectorAll('[data-theme-control]').forEach((e) => {
          const r = t(e, 'theme-control'),
            n = a(r);
          'phoenixNavbarTopShape' === r &&
            'dual-nav' === a('phoenixNavbarPosition') &&
            e.setAttribute('disabled', !0);
          const c = a('phoenixNavbarPosition');
          if (
            ('phoenixNavbarVerticalStyle' === r &&
              ('horizontal' === c || 'dual-nav' === c) &&
              e.setAttribute('disabled', !0),
            'checkbox' === e.type)
          )
            'phoenixTheme' === r
              ? ('auto' === n ? 'dark' === o() : 'dark' === n) &&
                e.setAttribute('checked', !0)
              : n && e.setAttribute('checked', !0);
        ...
        if (d.data('theme-control')) {
          ...
          switch (
            ...
            case 'phoenixTheme': {
              ...
              e.currentTarget.dispatchEvent(t), changeTheme(r.node);
              break;
            }
            case 'phoenixNavbarVerticalStyle':
              n.setAttribute('data-navbar-appearance', 'default'),
                'default' !== h &&
                  n.setAttribute('data-navbar-appearance', 'darker');
              break;
